            ...
            <table className={`w-full table-fixed border-2 border-[#002060] text-center ${dyn.tableText} font-serif border-collapse`}>
              ...
              <tbody className="divide-y divide-[#002060]">
                {subjectRows.map((sub, index) => {
                  const hasHyP2 = sub.hyPaper2Exists || (sub.hyPaper2Val !== undefined && sub.hyPaper2Val > 0);
                  const hasYP2 = sub.yPaper2Exists || (sub.yPaper2Val !== undefined && sub.yPaper2Val > 0);
                  ...
                  const hasHyPracOrOral = sub.hyPracExists || (sub.hyOralExists && !hasHyP2) || (sub.isSubjectPractical && hyPracMark > 0) || hyPracMark > 0;
                  ...
                  const hasYPracOrOral = sub.yPracExists || (sub.yOralExists && !hasYP2) || (sub.isSubjectPractical && yPracMark > 0) || yPracMark > 0;
